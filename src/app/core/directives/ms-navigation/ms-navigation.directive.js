(function ()
{
    ...
    function MsNavigationController($scope, msNavigationService)
    {
        ...
        if ( $scope.root )
        {
            ...
            if (window.localStorage['type'] != undefined) {
                vm.navigation.adminuser = window.localStorage['type'];
            }
        }
        else
        {
    ...
    function MsNavigationNodeController($scope, $element, $rootScope, $animate, $state, msNavigationService)
    {
        ...
        function isAdmin() {
            ...
            if (window.localStorage['type'] == "Admin")
            {
                return true;
            }
            if (window.localStorage['type'] == "Manager") {
                return true;
            }
            else {
                return false;
        ...
        function isUser() {
            ...
            if (window.localStorage['type'] != "Admin" && window.localStorage['type'] != "Manager") {
                return true;
            }
            else {
                return false;
